            ...
            <div class="col-md-12 col-sm-6">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="{{ route('accessibility.plans.create', $student->id) }}">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-10">
                                    ...
                                    <input type="text" class="form-control" id="chronogram" name="chronogram" value="{{ old('chronogram') }}" maxlength="100" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3">
                                    <label for="deficiency" class="form-label">Tipo de Deficiência ou Necessidade Educacional Especifica: *</label>
                                    <textarea class="form-control" id="deficiency" name="deficiency" rows="5" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3">
                                    <label for="objective" class="form-label">Objetivos do AEE: *</label>
                                    <textarea class="form-control" id="objective" name="objective" rows="5" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3">
                            ...
                            <div class="form-group">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="instrument" name="instrument" rows="5" required></textarea>
                                </div>
                            </div>
